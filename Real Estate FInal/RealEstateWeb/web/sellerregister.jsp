  ...
  border-top-right-radius: 0;
    ...
    <body class="text-center">
        ...
        <form action="sellerdetails " method ="get">
            ...
            <label for ="floating input" > Enter your site location:</label>
            </div>
            <div class="form-floating">
            <input type="text" class="form-control" id="floating input" name="stype">
            <label for ="floating input" > Enter type of property(apartment/plot/house):</label>
            </div>
            <div class="form-floating">
            <input type="text" class="form-control" id="floating input" name="scost">
            <label for ="floating input" > Enter cost of the site:</label>
            </div>
            <div class="form-floating">
            <input type="text" class="form-control" id="floating input" name="srent">
            <label for ="floating input" > Is it available for rent or sale:</label>
            </div>
