...
<head>
 ...
 <style>
              body{
                   background-image:url("https://images.pexels.com/photos/305831/pexels-photo-305831.jpeg?auto=compress&cs=tinysrgb&w=1600");
	   ...
	   <a class="navbar-brand" href="index.jsp"><i class="glyphicon glyphicon-home"></i>  Real-Estate</a>
		...
		<div class="container">
	    	...
	    	<div class="d-flex justify-content-center align-items-center ">
	    		<div class="row">
	    			<div class="col-sm-4">
	    				<h3><b>Admin REGISTER/LOGIN</b></h3>
	    			    <hr>
	    			</div>
	    		</div>
	    		...
	    		<div class="row">
					 <div class="col-sm-3">
						...
						<button type="button" onclick="location.href='admin.jsp'" class="btn btn-primary btn-lg btn-block">EXISTING USER</button>
